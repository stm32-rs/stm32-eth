...
<smoltcp::iface::interface::InterfaceInner::dispatch_ip>:
	...
	4642      	mov	r2, r8
	461c      	mov	r4, r3
	f007 ff1a 	bl	<smoltcp::iface::route::Routes::lookup>
	...
	4608      	mov	r0, r1
	2114      	movs	r1, #20
	f007 fd28 	bl	<smoltcp::wire::ip::checksum::data>
	43c0      	mvns	r0, r0
	4623      	mov	r3, r4
	ba00      	rev	r0, r0
	0c00      	lsrs	r0, r0, #16
	...
	b284      	uxth	r4, r0
	4650      	mov	r0, sl
	f007 fcb6 	bl	<smoltcp::wire::ip::checksum::data>
	...
	4622      	mov	r2, r4
	f007 f969 	bl	<smoltcp::wire::ipv4::Repr::emit>
	2c14      	cmp	r4, #20
	...
	f105 012a 	add.w	r1, r5, #42	@ 0x2a
	4632      	mov	r2, r6
	f007 f942 	bl	<smoltcp::wire::ipv4::Repr::emit>
	2e14      	cmp	r6, #20
	...
	4650      	mov	r0, sl
	4649      	mov	r1, r9
	f007 fb72 	bl	<smoltcp::wire::ip::checksum::data>
	43c0      	mvns	r0, r0
	ba00      	rev	r0, r0
	0c00      	lsrs	r0, r0, #16
	84a8      	strh	r0, [r5, #36]	@ 0x24
	...
	4619      	mov	r1, r3
	f005 fbf2 	bl	<smoltcp::wire::tcp::TcpOption::emit>
	4603      	mov	r3, r0
	460a      	mov	r2, r1
	...
	9128      	str	r1, [sp, #160]	@ 0xa0
	4619      	mov	r1, r3
	f005 fbd4 	bl	<smoltcp::wire::tcp::TcpOption::emit>
	4603      	mov	r3, r0
	460a      	mov	r2, r1
	f8dd b040 	ldr.w	fp, [sp, #64]	@ 0x40
	f1ba 0f00 	cmp.w	sl, #0
	...
	4620      	mov	r0, r4
	4619      	mov	r1, r3
	f005 fbbf 	bl	<smoltcp::wire::tcp::TcpOption::emit>
	4603      	mov	r3, r0
	460a      	mov	r2, r1
	f1b9 0f00 	cmp.w	r9, #0
	...
	a828      	add	r0, sp, #160	@ 0xa0
	4619      	mov	r1, r3
	f005 fbb0 	bl	<smoltcp::wire::tcp::TcpOption::emit>
	4603      	mov	r3, r0
	460a      	mov	r2, r1
	...
	4619      	mov	r1, r3
	f6c0 0000 	movt	r0, #2048	@ 0x800
	f005 fba5 	bl	<smoltcp::wire::tcp::TcpOption::emit>
	2c13      	cmp	r4, #19
	...
	b286      	uxth	r6, r0
	4650      	mov	r0, sl
	f007 faac 	bl	<smoltcp::wire::ip::checksum::data>
	...
	a813      	add	r0, sp, #76	@ 0x4c
	f004 fff4 	bl	<core::ptr::drop_in_place<core::result::Result<stm32_eth::dma::tx::TxPacket,stm32_eth::dma::tx::TxError>>>
	...
	9028      	str	r0, [sp, #160]	@ 0xa0
	a828      	add	r0, sp, #160	@ 0xa0
	f004 ffb4 	bl	<core::ptr::drop_in_place<core::result::Result<stm32_eth::dma::tx::TxPacket,stm32_eth::dma::tx::TxError>>>
	f64a 200c 	movw	r0, #43532	@ 0xaa0c
	f6c0 0000 	movt	r0, #2048	@ 0x800
...
<smoltcp::iface::interface::Interface::poll>:
	...
	2807      	cmp	r0, #7
	d87b      	bhi.n	<smoltcp::iface::interface::Interface::poll+0x202>
	fa0c f000 	lsl.w	r0, ip, r0
	f010 0faa 	tst.w	r0, #170	@ 0xaa
	bf08      	it	eq
	f8c4 c000 	streq.w	ip, [r4]
	e9da 1001 	ldrd	r1, r0, [sl, #4]
	4288      	cmp	r0, r1
	f082 80ce 	bcs.w	<smoltcp::iface::interface::Interface::poll+0x22be>
	fb00 f20e 	mul.w	r2, r0, lr
	f8da 3000 	ldr.w	r3, [sl]
	589a      	ldr	r2, [r3, r2]
	2a00      	cmp	r2, #0
	f101 8229 	bmi.w	<smoltcp::iface::interface::Interface::poll+0x1584>
	...
	2e07      	cmp	r6, #7
	d858      	bhi.n	<smoltcp::iface::interface::Interface::poll+0x212>
	fa0c f606 	lsl.w	r6, ip, r6
	...
	6823      	ldr	r3, [r4, #0]
	2b00      	cmp	r3, #0
	d4a8      	bmi.n	<smoltcp::iface::interface::Interface::poll+0xca>
	6823      	ldr	r3, [r4, #0]
	f413 4300 	ands.w	r3, r3, #32768	@ 0x8000
	d106      	bne.n	<smoltcp::iface::interface::Interface::poll+0x18e>
	6826      	ldr	r6, [r4, #0]
	05b6      	lsls	r6, r6, #22
	bf44      	itt	mi
	6826      	ldrmi	r6, [r4, #0]
	ea5f 56c6 	movsmi.w	r6, r6, lsl #23
	d449      	bmi.n	<smoltcp::iface::interface::Interface::poll+0x222>
	6a20      	ldr	r0, [r4, #32]
	2800      	cmp	r0, #0
	f002 802a 	beq.w	<smoltcp::iface::interface::Interface::poll+0x21ea>
	e9d4 0109 	ldrd	r0, r1, [r4, #36]	@ 0x24
	2900      	cmp	r1, #0
	60a0      	str	r0, [r4, #8]
	f002 802f 	beq.w	<smoltcp::iface::interface::Interface::poll+0x2200>
	...
	2c02      	cmp	r4, #2
	f3bf 8f5f 	dmb	sy
	d087      	beq.n	<smoltcp::iface::interface::Interface::poll+0xca>
	...
	4681      	mov	r9, r0
	46b4      	mov	ip, r6
	e76d      	b.n	<smoltcp::iface::interface::Interface::poll+0xde>
	f8c4 c000 	str.w	ip, [r4]
	e9da 1001 	ldrd	r1, r0, [sl, #4]
	4288      	cmp	r0, r1
	d389      	bcc.n	<smoltcp::iface::interface::Interface::poll+0x122>
	f002 b856 	b.w	<smoltcp::iface::interface::Interface::poll+0x22be>
	f8c4 c000 	str.w	ip, [r4]
	fb00 340e 	mla	r4, r0, lr, r3
	6823      	ldr	r3, [r4, #0]
	2b00      	cmp	r3, #0
	d5ab      	bpl.n	<smoltcp::iface::interface::Interface::poll+0x178>
...
<ip::__cortex_m_rt_main>:
	...
	f647 4065 	movw	r0, #31845	@ 0x7c65
	...
	465a      	mov	r2, fp
	4623      	mov	r3, r4
	f7fb f9f8 	bl	<smoltcp::iface::interface::Interface::poll>
	...
	f50d 50c9 	add.w	r0, sp, #6432	@ 0x1920
	462b      	mov	r3, r5
	f7fb f946 	bl	<smoltcp::iface::interface::Interface::poll>
	f8d6 18ec 	ldr.w	r1, [r6, #2284]	@ 0x8ec
	2900      	cmp	r1, #0
	...
	f50d 50c9 	add.w	r0, sp, #6432	@ 0x1920
	465a      	mov	r2, fp
	f7fb f927 	bl	<smoltcp::iface::interface::Interface::poll>
